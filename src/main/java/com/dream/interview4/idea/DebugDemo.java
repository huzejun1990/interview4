...
public class DebugDemo {
    ...
    private static void baseEmbed() {
        System.out.println("baseEmbed() -------------11111");
        System.out.println("baseEmbed() -------------22222");
        System.out.println("baseEmbed() -------------33333");
        System.out.println("baseEmbed() -------------44444");
    }
    ...
    public static void main(String[] args) {
        //1 第一组基础界面
        // 光标回到当前断点行 + 步过+步入+强制步入+步出+运行光标位置
//        helloDebug();
...
//        forceReturnAndStop();
        ...
        //4 四大断点 line Breakpoint+Field Watchpoint+Method Breakpoint+Exception Breakpoit
        //4.1 Line Breakpoint, 大家都懂，
...
//        computer.insert();
        ...
        //4.4.1 新增异常断点，点击 View Breakpoints...
        //4.4.2 选择异常类型
        //4.4.3 选择hit和log
        //4.4.4 运行含有null 异常的代码，自动闪电定位，不用人工打断点
        Integer i = null;
