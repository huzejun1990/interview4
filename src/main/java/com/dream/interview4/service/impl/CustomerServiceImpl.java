...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerMixInfo findCustomerByCompletableFuture() {
        ...
        /**
         * publice static CompletableFuture<Void>allOf(CompletableFuture<?>...cfs</?>)
         * 返回在所有给定的CompletableFutures完成时完成的新CompletableFuture
         * 如何任何给定的CompletableFutures异常完成，则返回的CompletableFuture也会这样做
         * 并且CompletionException将此异常作为其他原因。否则，给定的CompletableFuture的结果（如果有的话）
         ...
         * 异常
         * NullPointException - 如果数组或其任何元素是null
         *
         */
