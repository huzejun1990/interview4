...
import com.dream.interview4.entities.Constants;
import com.dream.interview4.entities.Content;
...
public class TaskService {
    ...
    public void init() {
        ...
        new Thread(() -> {
            ...
            while (true) {
                //2 模拟观众各种发言，5秒一批数据，自己模拟制造一批发言数据到100后break
                ...
                for (int i = 1; i <= 5; i++) {
                    ...
                    /**
                     * 4.1 redis的原生命令
                     * ZADD eky score1 member1 [score2 number2][score3 number3]
                ...
                //TODO 在分布式系统中，建议用xxl-job来实现定时，此处为了直播方便讲解，简单模拟
