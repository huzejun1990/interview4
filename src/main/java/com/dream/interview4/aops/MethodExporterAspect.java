package com.dream.interview4.aops;
...
public class MethodExporterAspect {
    ...
    //容器捞鱼，谁带着使用MethodExporter注解将会触发Around业务逻辑
    @Around("@annotation(com.dream.interview4.annotations.MethodExporter)")
    public Object methodExporter(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        MethodExporter methodAnnotation = method.getAnnotation(MethodExporter.class);
        ...
        if (methodAnnotation != null) {
            ...
            if (retValue != null) {
                //hutool.json 会出错
//                jsonResult = new ObjectMapper().writerValueAsString(retValue);
